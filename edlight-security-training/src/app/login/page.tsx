    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-6">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <Link
            href="/dashboard"
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-slate-200 bg-white px-5 py-3.5 text-[15px] font-semibold text-slate-700 shadow-sm hover:bg-slate-50 hover:border-slate-300 transition-all"
          >
            {/* Google Icon SVG */}
          ...
          <div className="mt-5 flex items-start gap-2.5 bg-slate-50 rounded-xl border border-slate-100 p-3.5">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              Access is restricted to <strong className="text-slate-600">@edlight.org</strong>{" "}
              accounts. Personal Google accounts will not be granted access.
            </p>
          </div>
        </div>
